...
def build_mini_swebench_command(
    *,
    ...
    extra_config_specs = _extra_config_specs(mini_config)
...
def _extra_config_specs(mini_config: MiniSweAgentConfig) -> list[str]:
    specs = []
    if mini_config.config_file is not None or mini_config.docker_platform is not None:
